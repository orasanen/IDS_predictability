...
for short = 0:1
    ...
    ids_i_selected = intersect(intersect(ids_i,find(nsyls >= minsyls_ids)),find(nsyls <= maxsyls_ids));
    ads_i_selected = intersect(intersect(ads_i,find(nsyls >= minsyls_ads)),find(nsyls <= maxsyls_ads));
